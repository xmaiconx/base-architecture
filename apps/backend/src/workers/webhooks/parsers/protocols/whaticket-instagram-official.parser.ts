...
/**
 * Parser para webhooks: Whaticket + Instagram + Official
 */
@Injectable()
export class WhaticketInstagramOfficialParser extends BaseWebhookParser {
  readonly providerName = 'WHATICKET';
  readonly defaultQueueName = 'webhook-whaticket-instagram-official';
  ...
  async parse(payload: unknown): Promise<ParsedWebhookData> {
    ...
    return {
      eventName: 'message.whaticket.instagram.official',
