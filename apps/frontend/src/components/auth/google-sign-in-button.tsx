 ...
 *
 * OAuth sign-in button for Google authentication via Supabase Auth.
 *
 * Features:
 ...
 * 4. Redirects back to /auth/callback with session
 * 5. Backend webhook creates Account/Workspace/User
